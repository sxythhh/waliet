    ...
    for (const account of accounts) {
      try {
        ...
        const analyticsData = {
          ...
          total_likes: account.total_likes || 0,
          total_comments: account.total_comments || 0,
          total_videos: account.total_videos_tracked || 0,
          total_bookmarks: account.total_bookmarks || 0,
          total_shares: account.total_shares || 0,
          average_video_views: account.median_views_non_zero || 0,
          median_views_non_zero: account.median_views_non_zero,
          percent_outperform_10x: account.percent_outperform_10x,
          percent_outperform_25x: account.percent_outperform_25x,
