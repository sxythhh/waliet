...
DROP POLICY IF EXISTS "Admins can view all campaign data including financials" ON public.campaigns;
...
DROP POLICY IF EXISTS "Only admins can manage encryption keys" ON public.encryption_keys;
...
BEGIN
  ...
  IF TG_OP = 'INSERT' THEN
    ...
    -- Send notification for admin role grants
...
-- Create indexes for faster role lookups and audit queries
