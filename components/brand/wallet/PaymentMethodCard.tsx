...
export function PaymentMethodCard({
  ...
  return (
    ...
    >
      ...
      {/* Title & Description */}
      <p className="text-xs font-medium font-inter tracking-[-0.3px] text-foreground">
        {config.title}
      </p>
      <p className="text-[11px] text-muted-foreground font-inter tracking-[-0.3px] mt-0.5 line-clamp-1">
        {config.description}
      </p>
    </button>
  );
