  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center py-6 px-4 rounded-xl bg-muted/30 border border-border/50">
        <p className="text-3xl font-semibold font-inter tracking-[-1px] text-foreground">
      ...
      <div className="space-y-3">
        <h4 className="text-sm font-medium font-inter tracking-[-0.3px] text-foreground">
          Breakdown
        </h4>
      ...
      <div className="flex items-center gap-3 p-4 rounded-xl bg-green-500/10 border border-green-500/20">
        ...
        <div className="flex-1">
          <p className="text-sm text-green-700 dark:text-green-400 font-inter tracking-[-0.3px]">
            You will receive
          </p>
          <p className="text-lg font-semibold text-green-700 dark:text-green-400 font-inter tracking-[-0.5px]">
