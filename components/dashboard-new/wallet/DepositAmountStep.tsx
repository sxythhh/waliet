  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-2">
        <label className="text-xs text-muted-foreground tracking-[-0.3px]">
          Amount
        </label>
        ...
        <div className="flex flex-wrap gap-2">
          {PRESET_AMOUNTS.map((preset) => (
            <button
              ...
              className={cn(
                "h-9 px-4 text-sm font-medium tracking-[-0.3px] rounded-lg transition-colors",
      ...
      {isPersonal && amount > personalBalance && (
        <p className="text-sm text-destructive tracking-[-0.3px]">
