...
"[project]/waliet/app/api/app/profile/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
[__TURBOPACK__imported__module__$5b$project$5d2f$waliet$2f$lib$2f$dual$2d$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$waliet$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
async function GET() {
    try {
        ...
        if (user.sellerProfile) {
            ...
            const completedSessions = await __TURBOPACK__imported__module__$5b$project$5d2f$waliet$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].session.findMany({
                where: {
            ...
            totalEarnings = completedSessions.reduce((sum, s)=>sum + (s.pricePerUnit || 0) * s.units, 0) / 100; // Convert cents to dollars
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$waliet$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            user: {
                ...
                sellerProfile: user.sellerProfile ? {
                    ...user.sellerProfile,
                    hourlyRate: user.sellerProfile.hourlyRate / 100,
                    totalEarnings,
                    totalClients
                } : null
            }
...
async function PATCH(request) {
    try {
        ...
        const { name, bio } = body;
        // Update user profile
        const updatedUser = await __TURBOPACK__imported__module__$5b$project$5d2f$waliet$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.update({
            where: {
                id: auth.dbUser.id
            },
            data: {
        ...
        if (updatedUser.sellerProfile) {
            ...
            totalEarnings = completedSessions.reduce((sum, s)=>sum + (s.pricePerUnit || 0) * s.units, 0) / 100;
            const uniqueBuyers = new Set(completedSessions.map((s)=>s.buyerId));
            totalClients = uniqueBuyers.size;
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$waliet$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1f19611d._.js.map