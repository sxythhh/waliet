  ...
  return <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[calc(100vw-2rem)] sm:max-w-2xl max-h-[90vh] overflow-y-auto p-4 sm:p-8">
        ...
        <div className="flex items-start gap-3 sm:gap-4 mb-4">
          ...
          {hasConnectedAccounts && <Button onClick={() => setShowSubmitVideoDialog(true)} className="h-9 px-4 rounded-[10px] font-medium text-sm bg-white hover:bg-neutral-100 text-black border border-border flex-shrink-0" style={{
          fontFamily: 'Inter',
          letterSpacing: '-0.5px'
        }}>
              Submit Video
