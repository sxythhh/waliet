...
const DialogFooter = ({
  ...
  <div className={cn("flex flex-col-reverse gap-2 sm:flex-row sm:justify-end sm:gap-3 pt-2", className)} {...props} />
);
...
const DialogTitle = React.forwardRef<React.ElementRef<typeof DialogPrimitive.Title>, React.ComponentPropsWithoutRef<typeof DialogPrimitive.Title>>(({
  ...
  <DialogPrimitive.Title 
    ref={ref} 
    className={cn("text-lg font-semibold leading-none font-geist tracking-[-0.5px]", className)} 
    {...props} 
  />
));
...
const DialogDescription = React.forwardRef<React.ElementRef<typeof DialogPrimitive.Description>, React.ComponentPropsWithoutRef<typeof DialogPrimitive.Description>>(({
  ...
  <DialogPrimitive.Description 
    ref={ref} 
    className={cn("text-sm text-muted-foreground font-inter tracking-[-0.5px]", className)} 
    {...props} 
  />
));
