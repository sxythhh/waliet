                ...
                return (
                  <SidebarMenuItem key={item.title}>
                    <SidebarMenuButton
                      ...
                      isActive={isActive}
                      className="h-10 py-2 text-[14.4px] font-medium font-instrument data-[active=true]:bg-primary data-[active=true]:text-white hover:bg-sidebar-accent text-[#C0C0C0]"
                    >
