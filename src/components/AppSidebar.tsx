          ...
          <SidebarGroupContent>
            <SidebarMenu>
              ...
              return <SidebarMenuItem key={item.title}>
                    <SidebarMenuButton onClick={() => handleTabClick(item.tab)} isActive={isActive} className="h-10 py-[6px] pl-3 text-[14.4px] font-semibold font-['Chakra_Petch'] tracking-[-0.5px] data-[active=true]:bg-transparent data-[active=true]:text-white hover:bg-sidebar-accent text-[#C0C0C0]">
