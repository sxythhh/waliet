  ...
  return <>
          ...
          <Popover>
            ...
            <PopoverContent className="w-72 p-0 bg-card" align="end">
              <div className="p-4 space-y-3">
                ...
                <button className="w-full flex items-center justify-between px-0 py-2 text-left hover:opacity-70 transition-opacity" onClick={() => window.open("https://virality.cc/feedback", "_blank")}>
                  <span className="font-medium text-sm">Give feedback</span>
                  <ArrowUpRight className="w-4 h-4" />
                </button>

                <button className="w-full flex items-center justify-between px-0 py-2 text-left hover:opacity-70 transition-opacity" onClick={() => window.open("https://virality.cc/help", "_blank")}>
                ...
                <div className="pt-4 border-t flex gap-4 text-sm text-muted-foreground">
                  <button className="hover:text-foreground transition-colors" onClick={() => window.open("https://virality.cc/privacy-policy", "_blank")}>
                    Privacy
                  </button>
                  <button className="hover:text-foreground transition-colors" onClick={() => window.open("https://virality.cc/terms", "_blank")}>
                    Terms
                  </button>
                </div>
              </div>
      ...
      <div className="flex items-center gap-0.5 md:gap-1">
        {menuItems.map(item => {
          ...
          return <button key={item.title} onClick={() => handleTabClick(item.tab)} className={`flex flex-col items-center justify-center gap-0.5 md:gap-1 w-14 h-12 md:w-auto md:h-auto md:px-6 md:py-2 rounded-lg transition-colors ${isActive ? 'bg-primary text-primary-foreground' : theme === 'light' ? 'text-muted-foreground hover:bg-[#F0F0F0]' : 'text-muted-foreground hover:text-foreground hover:bg-accent'}`}>
              {item.tab === "campaigns" ? <WebStoriesIcon className="h-4 w-4 md:h-5 md:w-5" /> : <item.icon className="h-4 w-4 md:h-5 md:w-5" />}
