        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
            ...
            <FormField control={form.control} name="email" render={({ field }) => (
              <FormItem>
                <FormLabel className="text-muted-foreground text-xs font-normal">Invite team member</FormLabel>
                <FormControl>
                  <Input 
                    type="email"
            ...
            <div className="flex items-center gap-2 pt-2">
              <Button 
                ...
                className="text-muted-foreground hover:text-foreground hover:bg-muted dark:hover:bg-[#1a1a1a] ml-auto"
              >
                Cancel
              </Button>
              <Button 
