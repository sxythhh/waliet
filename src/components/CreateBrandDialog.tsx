            ...
            <div className="max-h-[55vh] overflow-y-auto pr-2 space-y-3">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex flex-col gap-2">
                  {logoPreview ? <div className="relative w-24 h-24 rounded-lg overflow-hidden bg-muted">
                      <img src={logoPreview} alt="Brand logo" className="w-full h-full object-cover" />
                      <Button type="button" variant="destructive" size="icon" className="absolute top-1 right-1 h-6 w-6" onClick={removeLogo}>
                        <X className="h-3 w-3" />
                      </Button>
                    </div> : <div className="w-24 h-24 border-2 border-dashed rounded-lg flex items-center justify-center cursor-pointer hover:bg-muted/50 transition-colors" onClick={() => fileInputRef.current?.click()}>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                field
                      ...
                      <FormControl>
                        <Input placeholder="Enter brand name" className="h-9 text-sm" {...field} onChange={e => {
                    field.onChange(e);
                ...
                field
                      ...
                      <FormControl>
                        <Input placeholder="brand-slug" className="h-9 text-sm" {...field} onChange={e => {
                    const slug = e.target.value.toLowerCase().replace(/[^a-z0-9-]/g, "-").replace(/-+/g, "-").replace(/^-|-$/g, "");
                    field.onChange(slug);
                  }} />
                      </FormControl>
