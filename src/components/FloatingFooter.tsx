      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-auto py-2.5 md:h-10 md:py-0">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            <a href="https://x.com/JoinVirality" target="_blank" rel="noopener noreferrer" className="text-foreground/50 hover:text-foreground transition-colors" aria-label="X (Twitter)">
              <svg className="h-3.5 w-3.5 md:h-4 md:w-4" viewBox="0 0 24 24" fill="currentColor">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
              </svg>
            </a>
            <a href="https://instagram.com/viralitygg" target="_blank" rel="noopener noreferrer" className="text-foreground/50 hover:text-foreground transition-colors" aria-label="Instagram">
              <svg className="h-3.5 w-3.5 md:h-4 md:w-4" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="https://discord.gg/virality" target="_blank" rel="noopener noreferrer" className="text-foreground/50 hover:text-foreground transition-colors" aria-label="Discord">
              <svg className="h-3.5 w-3.5 md:h-4 md:w-4" viewBox="0 0 24 24" fill="currentColor">
