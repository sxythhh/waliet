          ...
          <div className="flex items-center justify-between h-14">
            <div className="flex items-center gap-6">
              ...
              <div className="hidden md:flex items-center gap-1">
                ...
                <Link 
                  to="/resources" 
                  className={`px-3 py-2 text-sm font-inter tracking-[-0.5px] ${isActive('/resources') ? 'text-white' : 'text-white/80 hover:text-white'}`}
                >
                  Resources
                </Link>
                ...
                <Link 
                  to="/contact" 
                  className={`px-3 py-2 text-sm font-inter tracking-[-0.5px] ${isActive('/contact') ? 'text-white' : 'text-white/80 hover:text-white'}`}
                >
                  Contact
                </Link>
              </div>
