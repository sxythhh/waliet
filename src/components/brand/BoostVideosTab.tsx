        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="w-[340px] flex-shrink-0 border-r border-border overflow-hidden flex flex-col">
            <div className="p-3 space-y-2">
              {[1, 2, 3].map((i) => (
                <div key={i} className="rounded-xl p-4 bg-card/30 border border-border/30 space-y-3">
          ...
          <div className="flex-1 overflow-hidden flex flex-col">
            ...
            <div className="flex-1 p-3 space-y-2">
              {[1, 2].map((i) => (
                <div key={i} className="rounded-xl bg-card/40 border border-border/40 overflow-hidden">
