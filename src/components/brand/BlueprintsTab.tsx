...
export function BlueprintsTab({
  ...
  return <div className="p-6 space-y-6">
      ...
      {blueprints.length === 0 ? <div className="w-full h-[calc(100vh-200px)] min-h-[500px]">
        ...
        return <div key={blueprint.id} onClick={() => openBlueprint(blueprint.id)} className={`group cursor-pointer rounded-xl overflow-hidden ${statusConfig.bgColor} flex flex-col h-full dark:border dark:border-[#0e0e0e]`}>
                    {/* Status Label */}
