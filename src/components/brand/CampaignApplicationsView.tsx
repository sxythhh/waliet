        ...
        {selectedApp ? <>
            <div className="flex-1 overflow-auto p-6 pb-24">
              <div className="space-y-6">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      {selectedApp.profile?.email && <p className="text-sm text-muted-foreground">{selectedApp.profile.email}</p>}
                    </div>
                  </div>
                ...
                {getAppUrl(selectedApp) && <div className="p-4 rounded-lg bg-muted/30">
                    <div className="flex items-center gap-3">
                      {selectedApp.platform && PLATFORM_LOGOS[selectedApp.platform] && <img src={PLATFORM_LOGOS[selectedApp.platform]} alt={selectedApp.platform} className="h-6 w-6" />}
                      <div className="flex-1">
                        {selectedApp.platform && <p className="font-medium capitalize">{selectedApp.platform}</p>}
                        <a href={getAppUrl(selectedApp)!} target="_blank" rel="noopener noreferrer" className="text-sm text-primary hover:underline flex items-center gap-1">
                ...
                {selectedApp.application_text && <div className="space-y-4">
                ...
                {selectedApp.application_answers && selectedApp.application_answers.length > 0 && <div className="space-y-4">
                    <h3 className="font-semibold">Application Answers</h3>
                    {selectedApp.application_answers.map((qa, index) => <div key={index} className="p-4 rounded-lg bg-muted/30">
