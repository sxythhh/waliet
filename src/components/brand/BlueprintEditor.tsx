          ...
          <div className="flex-1 overflow-auto">
            <div className="max-w-4xl mx-auto p-6 space-y-4">
              ...
              <div className="space-y-3">
                ...
                {/* Platforms Section */}
                {enabledSections.includes("platforms") && (
                  <BlueprintSection
                    id="platforms"
                    title="Platforms"
                ...
                {/* Brand Voice Section */}
                {enabledSections.includes("brand_voice") && (
                  <BlueprintSection
                    id="brand_voice"
                    title="Brand Voice"
                ...
                {/* Hooks Section */}
                {enabledSections.includes("hooks") && (
                  <BlueprintSection
                    id="hooks"
                    title="Hooks"
                ...
                {enabledSections.includes("talking_points") && (
                  <BlueprintSection
                    id="talking_points"
                ...
                {enabledSections.includes("dos_and_donts") && (
                  <BlueprintSection
                    id="dos_and_donts"
                    title="Do's & Don'ts"
                ...
                {enabledSections.includes("call_to_action") && (
                  <BlueprintSection
                    id="call_to_action"
                ...
                {/* Hashtags Section */}
                {enabledSections.includes("hashtags") && (
                  <BlueprintSection
                    id="hashtags"
                    title="Hashtags"
                ...
                {/* Assets Section */}
                {enabledSections.includes("assets") && (
                  <BlueprintSection
                    id="assets"
                    title="Assets & Files"
                ...
                {enabledSections.includes("example_videos") && (
                  <BlueprintSection
                    id="example_videos"
                ...
                {enabledSections.includes("target_personas") && (
                  <BlueprintSection
                    id="target_personas"
                          ...
                          <div key={index} className="rounded-md bg-muted/20 p-3 space-y-2 group">
                            <div className="flex items-center justify-between">
                              <Input
                                ...
                                className="h-8 bg-transparent border-0 focus-visible:ring-0 font-medium font-inter tracking-[-0.5px] text-sm px-0"
                              />
                              <Button
                                variant="ghost"
                                size="icon"
