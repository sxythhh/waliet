  ...
  return (
    <DialogPrimitive.Root open={open} onOpenChange={onOpenChange}>
      <DialogPrimitive.Portal>
        ...
        >
          {/* Disable focus trap to allow Whop popups to receive focus */}
          <FocusScope trapped={false} loop={false}>
            ...
            <div className="max-h-[70vh] overflow-y-auto [&_[data-whop-modal-overlay]]:bg-transparent [&_[data-radix-popper-content-wrapper]]:!z-[100]">
              <EmbeddedPayoutPortal brandId={brandId} redirectUrl={redirectUrl} />
            </div>
          </FocusScope>
          <DialogPrimitive.Close className="absolute right-4 top-4 rounded-full p-1.5 opacity-60 hover:opacity-100 hover:bg-white/10 transition-all">
