                  ...
                  <form onSubmit={form.handleSubmit(onSubmit)} className="max-w-2xl mx-auto">
                    ...
                    {currentStep === 3 && <div className="space-y-6">
                        ...
                        field
                              ...
                              <FormControl>
                                <Textarea placeholder="Enter campaign description..." className="min-h-[120px] bg-[#0a0a0a] border-[#1a1a1a] text-foreground placeholder:text-muted-foreground/50 focus:border-[#1a1a1a] focus:ring-0 focus:shadow-none focus-visible:ring-0 focus-visible:ring-offset-0 resize-none" style={{
                            letterSpacing: '-0.3px'
                          }} {...field} />
                              </FormControl>
                              <FormMessage />
