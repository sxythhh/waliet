...
import { 
  Eye, Target, TrendingUp, ArrowRight, Save, Upload, X, Check, 
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <Button
                      ...
                      size="sm"
                      className="h-7 gap-1"
                      onClick={() => currentStep < 3 ? handleNext() : form.handleSubmit(onSubmit)()}
                    >
