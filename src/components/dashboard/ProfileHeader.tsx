    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <h3 className="text-sm font-semibold text-foreground font-inter tracking-[-0.5px]">Connected Accounts</h3>
          <Button 
            size="sm" 
            variant="ghost" 
        ...
        {socialAccounts.length === 0 ? (
          <div className="bg-muted/30 dark:bg-[#0f0f0f] rounded-xl p-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {socialAccounts.map((account) => {
              ...
              return (
                <div 
                  key={account.id} 
                  className="group bg-muted/30 dark:bg-[#0f0f0f] rounded-xl p-3 flex items-center gap-3 border border-transparent hover:border-border/50 transition-colors"
                >
                  <div className="w-10 h-10 rounded-lg bg-muted dark:bg-[#1a1a1a] flex items-center justify-center shrink-0">
                    {platformIcon ? (
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-1.5">
                      <p className="text-sm font-semibold truncate font-inter tracking-[-0.5px]">
                        @{account.username}
                      </p>
                      {account.is_verified && (
