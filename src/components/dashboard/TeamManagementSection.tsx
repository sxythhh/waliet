    ...
    return (
      <div className="space-y-4">
        <div className="p-6 rounded-xl bg-[#f4f4f4] dark:bg-[#0f0f0f] text-center">
          ...
          <h3 className="font-semibold text-lg mb-2" style={{ fontFamily: 'Inter', letterSpacing: '-0.5px' }}>
            Create a Team
          </h3>
    ...
    <div className="space-y-6">
      ...
      <div className="p-5 rounded-xl bg-[#f4f4f4] dark:bg-[#0f0f0f] space-y-4">
        ...
        <div className="flex gap-2 items-stretch">
          <Input
            ...
            readOnly
            className="font-['Geist'] text-sm bg-background/50 border-0 h-10"
            style={{ letterSpacing: '-0.5px' }}
          />
          <Button
            onClick={copyTeamLink}
            variant="ghost"
            className="gap-2 shrink-0 h-10 bg-muted hover:bg-muted/80 text-muted-foreground"
          >
      ...
      {members.length > 0 && (
        <div className="space-y-3">
          ...
          {members.map((member) => (
            <div key={member.id} className="flex items-center justify-between p-3 rounded-lg bg-[#f4f4f4] dark:bg-[#0f0f0f]">
              <div className="flex items-center gap-3">
