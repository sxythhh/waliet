              ...
              return (
                ...
                >
                    ...
                    {connectedCampaigns.length > 0 ? (
                      <Popover>
                        <PopoverTrigger asChild>
                          <button
                            className="text-xs sm:text-sm text-foreground hover:underline cursor-pointer"
                  ...
                  <TableCell className="py-3">
                    <div className="flex items-center gap-2">
                      {account.is_verified ? (
                        <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium bg-green-500/10 text-green-600 dark:text-green-400 tracking-tight">
