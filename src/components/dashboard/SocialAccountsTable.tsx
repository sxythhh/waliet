      ...
      <Table>
        ...
        <TableBody>
          ...
          return <TableRow key={account.id} className="hover:bg-[#fafafa] dark:hover:bg-[#0a0a0a] transition-colors border-[#dce1eb] dark:border-[#141414]">
                ...
                <TableCell className="py-3">
                  <div className="flex items-center gap-2">
                    {account.is_verified ? <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium bg-green-500/10 text-green-600 dark:text-green-400 tracking-tight">
