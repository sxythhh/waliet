...
import { Eye, EyeOff, Mail, ArrowLeft, ExternalLink } from "lucide-react";
          ...
          {!showEmailForm ? <>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <Button variant="outline" className="w-full h-12 bg-[#5865F2] hover:bg-[#4752C4] text-white border-0 font-medium gap-3" onClick={handleDiscordSignIn} disabled={loading}>
                    <img alt="Discord" className="h-5 w-5" src="/lovable-uploads/38b60a02-7cb6-4adb-b1b9-62f4de7373fd.webp" />
                    Continue with Discord
                  </Button>
                  
                  <Button variant="outline" className="w-full h-12 bg-muted/50 hover:bg-muted border-0 font-medium gap-3" onClick={handleGoogleSignIn} disabled={loading}>
                  ...
                  <Button variant="outline" className="w-full h-12 bg-muted/50 hover:bg-muted border-0 font-medium gap-3" onClick={() => setShowEmailForm(true)} disabled={loading}>
              ...
              <div className="space-y-4">
                ...
                <Button variant="outline" className="w-full h-12 bg-muted/50 hover:bg-muted border-0 font-medium gap-2" onClick={() => navigate('/brand-auth')} disabled={loading}>
