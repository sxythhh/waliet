        ...
        <Card className="w-full max-w-md border-0 bg-card/50 backdrop-blur-sm shadow-xl">
          <CardHeader className="text-center space-y-4 pb-2">
            <div className="flex justify-center">
              <img 
                src="/lovable-uploads/cb6c1dd3-b66b-47b3-b6ea-4a3ca8b5a371.png" 
                alt="Virality Logo" 
            ...
            <>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <Button 
                    variant="outline" 
                    className="w-full h-12 bg-[#5865F2] hover:bg-[#4752C4] text-white border-0 font-medium gap-3"
                  ...
                  <Button 
                    variant="outline" 
                    className="w-full h-12 bg-muted/50 hover:bg-muted border-0 font-medium gap-3"
              ...
              <div className="space-y-4">
                ...
                <Button 
                  variant="outline" 
                  className="w-full h-12 bg-muted/50 hover:bg-muted border-0 font-medium gap-2"
