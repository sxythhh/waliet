        ...
        <Tabs defaultValue="analytics" className="w-full">
          ...
          <TabsContent value="analytics" className="space-y-4">
            <div className="flex justify-end mb-4">
              <ImportCampaignStatsDialog campaignId={selectedCampaignId} onImportComplete={fetchSubmissions} />
            </div>
                ...
                <CardContent>
                  <div className="h-[300px] flex items-center justify-center">
                    <div className="text-white/40 text-sm">
                      {approvedSubmissions.length > 0 ? `${approvedSubmissions.length} submissions tracked` : 'No data available'}
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-[#202020] border-transparent">
                ...
                <CardContent>
                  <div className="space-y-3">
                    {approvedSubmissions.length === 0 ? <div className="h-[300px] flex items-center justify-center text-white/40 text-sm">
                        No creator data available
                      </div> : approvedSubmissions.sort((a, b) => Number(b.earnings) - Number(a.earnings)).slice(0, 5).map(submission => <div key={submission.id} className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
              ...
              <Card className="bg-[#202020] border-transparent lg:col-span-2">
                ...
                <CardContent>
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="text-center">
                      <div className="text-2xl font-bold text-white">
                        {approvedSubmissions.length > 0 ? (totalViews / approvedSubmissions.length).toFixed(0) : '0'}
                      </div>
                      <div className="text-sm text-white/60 mt-1">Avg Views per Creator</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-white">
                        {approvedSubmissions.length > 0 ? (totalSpent / approvedSubmissions.length).toFixed(2) : '0.00'}
                      </div>
            ...
            <Card className="bg-gradient-card border-0">
              ...
              <CardContent className="space-y-3">
                {approvedSubmissions.length === 0 ? <div className="text-center py-8">
                    ...
                    {approvedSubmissions.map(submission => <Card key={submission.id} className="bg-background/50 border-0 overflow-hidden">
                        <CardContent className="p-4">
                          <div className="flex items-start gap-3">
                            {/* Creator Avatar & Info */}
                            <div className="flex-shrink-0">
                              {submission.profiles?.avatar_url ? <img src={submission.profiles.avatar_url} alt={submission.profiles.username} className="w-12 h-12 rounded-full object-cover border-2 border-success/30" /> : <div className="w-12 h-12 rounded-full bg-success/20 flex items-center justify-center">
                            ...
                            <div className="flex-1 space-y-2">
                              ...
                              {submission.content_url && <div className="pt-1">
                                  <a href={submission.content_url} target="_blank" rel="noopener noreferrer" className="text-xs text-primary hover:underline inline-flex items-center gap-1">
                                    View content →
                                  </a>
                                </div>}
                            </div>
            ...
            <Card className="bg-gradient-card border-0">
              ...
              <CardContent className="space-y-3">
                {pendingSubmissions.length === 0 ? <div className="text-center py-8">
                    ...
                    {pendingSubmissions.map(submission => <Card key={submission.id} className="bg-background/50 border-0 overflow-hidden">
                        <CardContent className="p-4">
                          <div className="flex items-start gap-3">
                            {/* Creator Avatar & Info */}
                            <div className="flex-shrink-0">
