      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {selectedCampaign && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card className="relative overflow-hidden border-0 bg-gradient-to-br from-purple-500/10 via-purple-600/10 to-pink-500/10 backdrop-blur-sm hover:scale-[1.02] transition-transform duration-300">
              ...
              <div className="relative p-6">
                ...
                <div className="w-full h-1.5 bg-purple-950/30 rounded-full overflow-hidden">
                  <div 
                    ...
                    style={{ width: `${Math.min((selectedCampaign.budget_used || 0) / (selectedCampaign.budget || 1) * 100, 100)}%` }}
                  />
                </div>
                <p className="text-xs text-muted-foreground mt-2">
                  {((selectedCampaign.budget_used || 0) / (selectedCampaign.budget || 1) * 100).toFixed(1)}% utilized
                </p>
              </div>
            </Card>

            {/* Budget Used Card with Bar Chart Visualization */}
            <Card className="relative overflow-hidden border-0 bg-gradient-to-br from-emerald-500/10 via-teal-600/10 to-cyan-500/10 backdrop-blur-sm hover:scale-[1.02] transition-transform duration-300">
              ...
              <div className="relative p-6">
                ...
                <div className="flex items-end justify-between gap-1 h-12">
                  {Array.from({length: 12}).map((_, i) => (
                    <div 
                      key={i}
                      className="flex-1 bg-gradient-to-t from-emerald-500 to-teal-400 rounded-sm opacity-60 hover:opacity-100 transition-opacity"
            ...
            <Card className="relative overflow-hidden border-0 bg-gradient-to-br from-blue-500/10 via-indigo-600/10 to-purple-500/10 backdrop-blur-sm hover:scale-[1.02] transition-transform duration-300">
              ...
              <div className="relative p-6">
                ...
                <div className="flex items-center gap-2 mt-2">
                  <div className="flex-1 h-2 bg-blue-950/30 rounded-full overflow-hidden">
                    <div 
                      className="h-full bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full"
                      style={{ width: `${Math.max(100 - (selectedCampaign.budget_used || 0) / (selectedCampaign.budget || 1) * 100, 0)}%` }}
                    />
                  </div>
                  <span className="text-xs text-muted-foreground whitespace-nowrap">
                    {Math.max(100 - ((selectedCampaign.budget_used || 0) / (selectedCampaign.budget || 1) * 100), 0).toFixed(1)}%
                  </span>
                </div>
              </div>
            </Card>
            ...
            {/* RPM Rate Card */}
            <Card className="relative overflow-hidden border-0 bg-gradient-to-br from-amber-500/10 via-orange-600/10 to-red-500/10 backdrop-blur-sm hover:scale-[1.02] transition-transform duration-300">
              <div className="absolute inset-0 bg-gradient-to-br from-amber-500/5 to-transparent" />
              <div className="relative p-6">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <p className="text-sm font-medium text-muted-foreground">RPM Rate</p>
                    <p className="text-xs text-muted-foreground/70 mt-0.5">Running Efficiently</p>
                  </div>
                ...
                <div className="flex items-baseline gap-2 mb-4">
                  ...
                  <span className="text-sm text-muted-foreground">per 1K</span>
                </div>
                <div className="grid grid-cols-2 gap-2">
                  <div className="p-2 rounded-lg bg-amber-500/10 border border-amber-500/20">
                    <p className="text-xs text-muted-foreground">Effective</p>
                    <p className="text-sm font-semibold text-amber-400">${selectedCampaign.rpm_rate?.toFixed(2) || '0.00'}</p>
                  </div>
                  <div className="p-2 rounded-lg bg-orange-500/10 border border-orange-500/20">
                    <p className="text-xs text-muted-foreground">Original</p>
                    <p className="text-sm font-semibold text-orange-400">${selectedCampaign.rpm_rate?.toFixed(2) || '0.00'}</p>
                  </div>
                </div>
              </div>
            </Card>

            {/* Creators/Submissions Card with Dot Grid */}
            <Card className="relative overflow-hidden border-0 bg-gradient-to-br from-violet-500/10 via-fuchsia-600/10 to-pink-500/10 backdrop-blur-sm hover:scale-[1.02] transition-transform duration-300">
                  ...
                  {Array.from({length: 50}).map((_, i) => (
                    <div 
                      ...
                      className={`w-1.5 h-1.5 rounded-full ${
                        i < approvedSubmissions.length ? 'bg-violet-400' : 'bg-violet-950/30'
                      }`}
                    />
                  ))}
                </div>
                <p className="text-xs text-muted-foreground mt-3">
                  <span className="text-emerald-400 font-semibold">50%</span> approval rate
                </p>
              </div>
            </Card>

            {/* Status Card */}
            <Card className="relative overflow-hidden border-0 bg-gradient-to-br from-cyan-500/10 via-sky-600/10 to-blue-500/10 backdrop-blur-sm hover:scale-[1.02] transition-transform duration-300">
              ...
              <div className="relative p-6">
                ...
                <p className="text-4xl font-bold text-foreground capitalize mb-4">
                ...
                <div className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-full ${
                  ...
                  <span className={`text-xs font-medium ${
                    ...
                    {selectedCampaign.status === 'active' ? 'Live Now' : 'Paused'}
                  </span>
                </div>
              </div>
            </Card>
