              ...
              {isAuthenticated ? (
                ...
                <>
                  <Button
                    variant="ghost"
                    size="sm"
                    className="font-geist font-medium tracking-[-0.5px] hover:bg-muted hover:text-foreground px-[10px] rounded-3xl"
