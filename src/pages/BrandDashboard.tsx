...
export default function BrandDashboard() {
  ...
  if (brand.brand_type === "DWY" && brand.home_url) {
    return <div className="h-screen w-full bg-[#191919]">
        <iframe src={brand.home_url} className="w-full h-full border-0" title={`${brand.name} Dashboard`} sandbox="allow-scripts allow-same-origin allow-forms" />
      </div>;
  }
