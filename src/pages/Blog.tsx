      ...
      <>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
              {loading ? <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  {blogPosts.map(post => <article key={post.id} className="group cursor-pointer bg-[#111] border border-white/5 rounded-xl overflow-hidden hover:border-white/10 transition-all hover:shadow-lg hover:shadow-black/20" onClick={() => setSelectedPost(post)}>
                      ...
                      <div className="p-5">
                        ...
                        {post.excerpt && <p className="text-white/60 text-sm font-inter tracking-[-0.5px] mb-4 line-clamp-2">
                            {post.excerpt}
                          </p>}
              ...
              <div className="mt-16 flex flex-col md:flex-row items-center justify-between gap-6 p-8 bg-gradient-to-r from-[#1a1a1a] to-[#0f0f0f] border border-white/10 rounded-2xl">
                ...
                <Button onClick={() => setShowAuthDialog(true)} className="font-inter tracking-[-0.5px] bg-primary hover:bg-primary/90 whitespace-nowrap">
                  Create Free Account
                  <ArrowRight className="w-4 h-4 ml-2" />
                </Button>
              </div>
