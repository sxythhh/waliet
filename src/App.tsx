    ...
    <AuthProvider>
      <TooltipProvider>
        ...
        <Routes>
          ...
          <Route path="/brand/:slug" element={<BrandLayout><BrandManagement showVideosTab={true} showImportButton={true} showAnalyticsTable={true} /></BrandLayout>} />
          <Route path="/brand/management/:slug" element={<BrandLayout><BrandManagement showVideosTab={false} showImportButton={false} showAnalyticsTable={false} /></BrandLayout>} />
