        ...
        <DialogContent className="max-w-md p-0 gap-0 overflow-hidden">
          <div className="flex flex-col items-center justify-center py-16 px-6 text-center">
            ...
            <button
              ...
              className="py-2 px-4 bg-primary border-t border-primary/70 rounded-lg font-inter text-[14px] font-medium tracking-[-0.5px] text-white hover:bg-primary/90 transition-colors flex items-center justify-center gap-2"
            >
